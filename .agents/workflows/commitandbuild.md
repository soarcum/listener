        ...
        if ($run.status -eq "completed") {
            ...
            if ($run.conclusion -eq "success") {
                ...
                if ($null -ne $failedJob) {
                    ...
                    # 获取日志并显示最后 50 行
                    # Use Invoke-WebRequest to download plain text logs. We handle redirection manually to avoid forwarding authorization headers to Amazon S3
                    try {
